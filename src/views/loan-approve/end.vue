...
<div v-else-if="column.property=='opts'">
  <el-button  @click="showend(row)" type="primary">查看</el-button>
...
<script>
import {sousuoend,searchend,passend, approveend} from '@/apis/loan'
export default {
name:'end',
data(){
    return {
...
this.getend()
    ...
    let res=await searchend(this.params)
    console.log('!!!!',res);  
  if(res.data.code===20000){
    ...
    async getend(){
  let res=await sousuoend(this.params)
  console.log(res);
 ...
 this.rows=res.data.data.rows
    ...
    async submit(id,zt){
        ...
        let res=await approveend(id,zt)
